...
class WPSC_Email_TestCase extends WP_UnitTestCase {
	 ...
	 */
	function test_can_send_email_validation() {
	...
	/**
	 * @TODO - test that subject line is autogenerated correctly if not provided.
	 */
	function test_subject_generation() {
	 ...
	 */
	function test_default_from_address() {

	}

	function test_auto_plain_text_generation() {
