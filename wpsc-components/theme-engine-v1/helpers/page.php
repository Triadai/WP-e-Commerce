...
function wpsc_register_core_theme_files() {
	...
	wpsc_register_theme_file( 'wpsc-html-email-header.php' );
	wpsc_register_theme_file( 'wpsc-html-email-footer.php' );
	wpsc_register_theme_file( 'wpsc-plain-email-header.php' );
	wpsc_register_theme_file( 'wpsc-plain-email-footer.php' );
